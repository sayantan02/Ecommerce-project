...
export interface ApiHomeListingHomeListing extends Schema.SingleType {
  collectionName: 'home_listings';
  info: {
    singularName: 'home-listing';
    pluralName: 'home-listings';
    displayName: 'Home_listing';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    payment_method: Attribute.Enumeration<['PENDING', 'COMPLETED', 'FAILED']>;
    order_status: Attribute.Enumeration<
      ['ORDER_PENDING', 'ORDER_ACCEPTED', 'ORDER_ON_THE_WAY', 'ORDER_DELIVERED']
    >;
    merchantTransactionId: Attribute.String;
    total_price: Attribute.Integer;
    product_item: Attribute.Component<'order-product.ordered-product', true>;
    isReceived: Attribute.Boolean;
    shippings: Attribute.Relation<
      'api::order.order',
      'oneToMany',
      'api::shipping.shipping'
...
export interface ApiPaymentHistoryPaymentHistory extends Schema.CollectionType {
  ...
  attributes: {
    merchantTransactionId: Attribute.String & Attribute.Required;
    transactionId: Attribute.String;
    state: Attribute.Enumeration<['PENDING', 'COMPLETED', 'FAILED']>;
    ...
    bankId: Attribute.String;
    bankTransactionId: Attribute.String;
    pgTransactionId: Attribute.String;
    pgServiceTransactionId: Attribute.String;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    offer_price: Attribute.Integer;
    is_active: Attribute.Boolean;
    offer_date: Attribute.DateTime;
    ...
    product_size: Attribute.Enumeration<['SM', 'LG', 'XL', 'XXL', 'XXXL']>;
